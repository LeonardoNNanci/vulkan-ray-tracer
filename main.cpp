...
void raytrace(vk::CommandBuffer commandBuffer)
{
    ...
    Ray pcRay;
    pcRay.clearColor = glm::vec4(0.);
    pcRay.lightPosition = glm::vec4(2., 2., 2., 1.);
    pcRay.lightIntensity = .8;
    pcRay.lightType = 1;
    ...
    pcRay.projInv = glm::inverse(glm::perspective(glm::radians(45.0f), Util::swapchain->extent.width / (float)Util::swapchain->extent.height, 0.1f, 10.0f));
    pcRay.viewInv = glm::inverse(glm::lookAt(glm::vec3(cameraPosition), glm::vec3(0.f, 0.0f, 0.5f), glm::vec3(0.0f, 0.0f, -1.0f)));
...
//					.addExtensions(PresentationBuilder::getRequiredExtensions())
//				.build();
